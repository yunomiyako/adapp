		...
		return (
                <div className={style.TopPage}>
						...
						<div className={style.title}>
							<DesktopBreakpoint>
							<h3 className={style.text1}>{title}</h3>
							</DesktopBreakpoint>	

							<PhoneBreakpoint>
							<h3 className={style.text1_2}>{title}</h3>
							</PhoneBreakpoint>

							<TabletBreakpoint>
							<h3 className={style.text1_3}>{title}</h3>
							</TabletBreakpoint>
						...
						<div className={style.Text}>
							...
							<DesktopBreakpoint>	
							<h2 className={style.text2}>{text1}</h2>
							</DesktopBreakpoint>
							...
							<PhoneBreakpoint>
							<h2 className={style.text2_2}>{text1}</h2>
							</PhoneBreakpoint>
