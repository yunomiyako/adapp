...
import style from "./PrivacyPolicyPage.css"
		...
		return (
			<div className = {style.PrivacyPolicyPage}>
				<Segment stacked>
					<br/><br/>
					<h1>プライバシーポリシー</h1>
					<p>AdApp（以下，「本サービス」といいます。）は，プライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
					...
					<ul>
						<li>本サービスは，ユーザーが利用登録をする際にTwitterのユーザ名、ユーザIDなどの個人情報を取得することがあります。</li>
						<li>本サービスは，ユーザーについて，投稿した文章や画像、および閲覧したページの情報を、本サービスを利用しまたはページを閲覧する際に収集します。</li>
					</ul>

					<h2>第３条（個人情報を収集・利用する目的）</h2>
					<p>当社が個人情報を収集・利用する目的は，以下のとおりです。</p>
					<ul class="child">
						<li>（1）ユーザーに自分の登録情報の閲覧、公開をする目的で登録されたTwitterアカウントのユーザ名、アイコン画像、ユーザIDを取得します。</li>
						<li>（2）ユーザが簡便に登録ができるように、ユーザーのご指示に基づいてTwitterに転送したりする目的</li>
						<li>（3）第三者に損害を発生させたりするなど，本サービスの利用規約に違反したユーザーや，不正・不当な目的でサービスを利用しようとするユーザーの利用をお断りするために，利用態様，登録情報など個人を特定するための情報を利用する目的</li>
						<li>（4）上記の利用目的に付随する目的</li>
					</ul>
